...
const AssessmentEntry: React.FC<{
  ...
  >
    {/* Header section with name, date, and remove button */}
    <div className="flex items-center justify-between p-3 border-b bg-gray-50">
      <div
        className="flex items-center gap-2"
        style={{ color: assessment.color }}
      >
        <div className="w-1 h-4 rounded-full" style={{ backgroundColor: assessment.color }} />
        <div className="font-medium text-[11px]">{assessment.name}</div>
      </div>
      ...
      <div className="flex items-center gap-4">
        <input
          ...
          className="text-[11px] border rounded px-2 py-1 w-28 focus:ring-1 focus:ring-blue-200 outline-none bg-white"
        />
        <button
    ...
    <div className="p-3">
      <input
        ...
        className="text-[11px] border rounded px-2 py-1.5 w-full focus:ring-1 focus:ring-blue-200 outline-none"
      />
    </div>
  </motion.div>
);
    ...
    <div className="w-full bg-white rounded-lg shadow-sm">
      <div className="p-6">
        ...
        {selectedAssessments.length > 0 && (
          <div className="overflow-auto border rounded-xl bg-gray-50/50">
            <div className="p-4">
              <h3 className="text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-4 px-2">
