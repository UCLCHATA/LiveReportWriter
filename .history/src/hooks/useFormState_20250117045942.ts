      ...
      try {
        ...
        const essentialState = {
          ...
          clinician: state.clinician ? {
            name: state.clinician.name || state.clinician.name === '' ? state.clinician.name : prev?.clinician?.name,
            email: state.clinician.email || state.clinician.email === '' ? state.clinician.email : prev?.clinician?.email,
            clinicName: state.clinician.clinicName || state.clinician.clinicName === '' ? state.clinician.clinicName : prev?.clinician?.clinicName,
