...
export const useFormState = () => {
  ...
  const isBaseAssessment = (assessment: any): assessment is SensoryProfileAssessment | SocialCommunicationAssessment | BehaviorInterestsAssessment => {
    ...
    setGlobalState(prev => {
      ...
      if (isBaseAssessment(prevAssessment)) {
        ...
        console.log('📝 Updating assessment:', {
          ...
          progress,
          isComplete,
          domains: Object.keys((data as any).domains || {}).length
        });
