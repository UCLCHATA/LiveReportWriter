...
const initialState: GlobalFormState = {
  ...
  assessments: {
    ...
    socialCommunication: {
      ...
      domains: {
        jointAttention: { name: 'Joint Attention', value: 0, observations: [], label: 'Not Assessed' },
        nonverbalCommunication: { name: 'Nonverbal Communication', value: 0, observations: [], label: 'Not Assessed' },
        verbalCommunication: { name: 'Verbal Communication', value: 0, observations: [], label: 'Not Assessed' },
        socialUnderstanding: { name: 'Social Understanding', value: 0, observations: [], label: 'Not Assessed' },
        playSkills: { name: 'Play Skills', value: 0, observations: [], label: 'Not Assessed' },
        peerInteractions: { name: 'Peer Interactions', value: 0, observations: [], label: 'Not Assessed' }
      },
      progress: 0,
      isComplete: false
    },
    behaviorInterests: {
      ...
      domains: {
        repetitiveBehaviors: { name: 'Repetitive Behaviors', value: 0, observations: [], label: 'Not Assessed' },
        routinesRituals: { name: 'Routines & Rituals', value: 0, observations: [], label: 'Not Assessed' },
        specialInterests: { name: 'Special Interests', value: 0, observations: [], label: 'Not Assessed' },
        sensoryInterests: { name: 'Sensory Interests', value: 0, observations: [], label: 'Not Assessed' },
        emotionalRegulation: { name: 'Emotional Regulation', value: 0, observations: [], label: 'Not Assessed' },
        flexibility: { name: 'Flexibility', value: 0, observations: [], label: 'Not Assessed' }
      },
      progress: 0,
      isComplete: false
    },
