...
import type { AssessmentData, FormState, GlobalState } from '../types';
...
export const useFormState = () => {
  ...
  const setChataId = useCallback((chataId: string) => {
    ...
    console.log('[useFormState] Saved form:', savedForm);
  ...
  const updateAssessments = useCallback((updates: Partial<AssessmentData>) => {
    console.log('[useFormState] Updating assessments:', updates);
    ...
    setGlobalState((prev: GlobalState) => {
      ...
      console.log('[useFormState] New assessment state:', newAssessments);
