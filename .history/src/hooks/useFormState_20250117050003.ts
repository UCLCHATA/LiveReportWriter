      ...
      try {
        ...
        const essentialState = {
          ...
          clinician: state.clinician ? {
            name: state.clinician.name || state.clinician.name === '' ? state.clinician.name : previousState?.clinician?.name,
            email: state.clinician.email || state.clinician.email === '' ? state.clinician.email : previousState?.clinician?.email,
            clinicName: state.clinician.clinicName || state.clinician.clinicName === '' ? state.clinician.clinicName : previousState?.clinician?.clinicName,
            childFirstName: state.clinician.childFirstName || '',
            childLastName: state.clinician.childLastName || '',
            childAge: state.clinician.childAge || '',
            childGender: state.clinician.childGender || '',
