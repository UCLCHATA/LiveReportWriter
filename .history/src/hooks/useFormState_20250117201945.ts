...
const formPersistence = new (class FormPersistenceService {
  ...
  saveForm(form: { chataId: string; clinicianInfo: ClinicianInfo; formData: FormData; assessments: AssessmentData; lastUpdated: number; isSubmitted: boolean; isDirty: boolean }) { }
  clearForm() { }
})();
...
const initialState: GlobalFormState = {
  ...
  formData: initialFormData as unknown as FormState,
