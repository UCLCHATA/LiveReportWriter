...
// Constants
const STORAGE_KEY_PREFIX = 'r3_form_';
const DRAFT_KEY_PREFIX = 'r3_draft_';
const ASSESSMENT_KEY = 'r3_assessment_data';
...
export const useFormState = () => {
  ...
  const setClinicianInfo = useCallback((info: ClinicianInfo) => {
    ...
    setGlobalState(prev => {
      ...
      // Save to form persistence format
      const storageKey = getStorageKey(newState.chataId);
      try {
        ...
        console.log('💾 Saved clinician info to storage:', {
          storageKey,
