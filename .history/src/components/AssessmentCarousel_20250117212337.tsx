...
interface ComponentProps<T extends AssessmentData[ToolId]> {
  data: T;
  onChange: (data: T) => void;
}

interface Tool<T extends AssessmentData[ToolId]> {
  id: ToolId;
  title: string;
...
const tools: Tool<AssessmentData[ToolId]>[] = [
  {
    id: 'sensoryProfile',
    title: 'Sensory Profile',
    component: SensoryProfileBuilder as React.ComponentType<ComponentProps<SensoryProfileData>>,
  ...
  },
  {
    ...
    component: SocialCommunicationProfile as React.ComponentType<ComponentProps<SocialCommunicationData>>,
  ...
  },
  {
    ...
    component: BehaviorInterestsProfile as React.ComponentType<ComponentProps<BehaviorInterestsData>>,
  ...
  },
  {
    ...
    component: MilestoneTracker as React.ComponentType<ComponentProps<MilestoneTrackerData>>,
  ...
  },
  {
    ...
    component: AssessmentLogger as React.ComponentType<ComponentProps<AssessmentLogData>>,
  ...
  },
  {
    id: 'summary',
    title: 'Summary',
    component: AssessmentSummary as React.ComponentType<ComponentProps<AssessmentSummaryData>>,
