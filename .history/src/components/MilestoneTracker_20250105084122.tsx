...
const ExpectationLine: React.FC<{
  ...
  // For early placement (actual < expected):
  // - Line starts from right edge of bubble (actualX + bubbleHalfWidth)
  // - Extends to expected position
  // For delayed placement (actual > expected):
  // - Line starts from left edge of bubble (actualX - bubbleHalfWidth)
  // - Extends back to expected position
  const bubbleHalfWidth = 0.8; // Approximate half width of bubble in percentage
  const startX = isEarly ? actualX + bubbleHalfWidth : expectedX;
