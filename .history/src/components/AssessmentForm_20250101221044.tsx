...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ onClear }) => {
  ...
  const renderModal = () => {
    ...
    // Get the section color based on the field
    ...
    // Get the section icon based on the field
      ...
      <div className={styles.modalOverlay} onClick={handleModalClose}>
        ...
        >
          ...
          <textarea
            ...
            autoFocus
          />
          <div className={`${styles.textLengthIndicator} ${styles[getTextLengthStatus(modalContent.value).status]}`}>
