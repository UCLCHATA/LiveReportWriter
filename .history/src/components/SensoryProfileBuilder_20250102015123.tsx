...
export const SensoryProfileBuilder: React.FC = () => {
  const [domains, setDomains] = useState<Record<string, SensoryDomain>>({
    visual: { name: 'Visual', sensitivity: 1, observations: [], label: 'Hypo-responsive' },
    auditory: { name: 'Auditory', sensitivity: 1, observations: [], label: 'Hypo-responsive' },
    tactile: { name: 'Tactile', sensitivity: 1, observations: [], label: 'Hypo-responsive' },
    vestibular: { name: 'Vestibular', sensitivity: 1, observations: [], label: 'Hypo-responsive' },
    proprioceptive: { name: 'Proprioceptive', sensitivity: 1, observations: [], label: 'Hypo-responsive' },
    oral: { name: 'Oral', sensitivity: 1, observations: [], label: 'Hypo-responsive' },
  });
