      ...
      try {
        ...
        const sheetyResponse = await submitFormData({
          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                domains: globalState.assessments.sensoryProfile.domains
              },
              socialCommunication: {
                domains: globalState.assessments.socialCommunication.domains
              },
              behaviorInterests: {
                domains: globalState.assessments.behaviorInterests.domains
              },
              assessmentLog: {
