...
type CategoryType = 'communication' | 'motor' | 'social' | 'cognitive';

interface CategoryInfoMap {
  communication: CategoryInfo;
  motor: CategoryInfo;
  social: CategoryInfo;
  cognitive: CategoryInfo;
}
...
const categoryInfo: CategoryInfoMap = {
  ...
  cognitive: {
    ...
    color: '#9F7AEA',
    tooltips: {
      'Object permanence': 'Understands objects exist even when hidden',
      'Problem solving': 'Shows ability to figure out simple puzzles',
      'Symbolic play': 'Uses objects to represent other things in play',
      'Sorting': 'Can group similar objects together',
      'Counting': 'Demonstrates basic number concepts'
    }
  }
};
      ...
      >
        ...
        <div className={styles.notesSection}>
          ...
          <textarea
            ...
            placeholder="Add any additional observations or notes about the child's development..."
          />
        </div>
      </DndContext>
    </div>
