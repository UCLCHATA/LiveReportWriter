...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ 
  ...
  useEffect(() => {
    if (chataId) {
      console.log('Attempting to restore form state for:', chataId);
      const savedForm = formPersistence.getForm(chataId);
      if (savedForm?.formState) {
        console.log('Restoring form state:', savedForm.formState);
        ...
        console.log('No saved form state found for:', chataId);
      }
    }
