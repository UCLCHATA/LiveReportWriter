...
import { submitFormData, generateImage, formatImageData } from '../services/api';
      ...
      if (!includeInReport) {
        ...
        if (wrapperRef.current) {
          ...
          try {
            ...
            // Format image data with include flag
            const imageData = formatImageData(base64Data, true);
            console.log('[MilestoneTracker] Image data formatted with include flag');
            ...
            console.log('[MilestoneTracker] Updating form data with image');
            onChange(updatedData);
