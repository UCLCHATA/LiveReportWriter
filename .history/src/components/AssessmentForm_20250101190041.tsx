        ...
        <div className={styles.textAreasGrid}>
          <div className={styles.gridColumn}>
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                <Search className={`${styles.sectionIcon} ${styles.solid}`} size={18} strokeWidth={3} />
            ...
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                <AlertTriangle className={`${styles.sectionIcon} ${styles.solid}`} size={18} strokeWidth={3} />
          ...
          <div className={styles.gridColumn}>
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                <Dumbbell className={`${styles.sectionIcon} ${styles.solid}`} size={18} strokeWidth={3} />
            ...
            <div className={styles.formSection}>
              <div className={styles.sectionHeader}>
                <ThumbsUp className={`${styles.sectionIcon} ${styles.solid}`} size={18} strokeWidth={3} />
