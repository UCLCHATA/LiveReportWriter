            ...
            <div className={styles['referrals-grid']}>
              <div className={styles['referral-checkbox']}>
                <input
                  ...
                  onChange={(e) => handleReferralChange('speech', e.target.checked)}
                />
              ...
              <div className={styles['referral-checkbox']}>
                <input
                  ...
                  onChange={(e) => handleReferralChange('educational', e.target.checked)}
                />
              ...
              <div className={styles['referral-checkbox']}>
                <input
                  ...
                  onChange={(e) => handleReferralChange('sleep', e.target.checked)}
                />
              ...
              <div className={styles['referral-checkbox']}>
                <input
                  ...
                  onChange={(e) => handleReferralChange('occupational', e.target.checked)}
                />
              ...
              <div className={styles['referral-checkbox']}>
                <input
                  ...
                  onChange={(e) => handleReferralChange('mental', e.target.checked)}
                />
