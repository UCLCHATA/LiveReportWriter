...
export const SocialCommunicationProfile: React.FC = () => {
  const [domains, setDomains] = useState<Domain[]>([
    { name: 'Joint Attention', value: 1, observations: [] },
    { name: 'Social Reciprocity', value: 1, observations: [] },
    { name: 'Verbal Communication', value: 1, observations: [] },
    { name: 'Non-verbal Communication', value: 1, observations: [] },
    { name: 'Social Understanding', value: 1, observations: [] },
    { name: 'Play Skills', value: 1, observations: [] },
  ]);
