...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ onClear, onProgressUpdate }) => {
  ...
  useEffect(() => {
    ...
    console.log('Form Progress Breakdown:', {
      textFields: {
        clinicalObservations: textFields.clinicalObservations ? 10 : 0,
        strengthsAbilities: textFields.strengthsAbilities ? 10 : 0,
        prioritySupportAreas: textFields.prioritySupportAreas ? 10 : 0,
        supportRecommendations: textFields.supportRecommendations ? 10 : 0
      },
      status: {
