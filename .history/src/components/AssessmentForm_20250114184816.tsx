          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                type: 'sensoryProfile',
                domains: {
                  visual: { label: 'Typical', name: 'visual', value: 3, observations: globalState.assessments.sensoryProfile.domains.visual?.observations },
                  auditory: { label: 'Typical', name: 'auditory', value: 3, observations: globalState.assessments.sensoryProfile.domains.auditory?.observations },
                  tactile: { label: 'Typical', name: 'tactile', value: 3, observations: globalState.assessments.sensoryProfile.domains.tactile?.observations },
                  vestibular: { label: 'Typical', name: 'vestibular', value: 3, observations: globalState.assessments.sensoryProfile.domains.vestibular?.observations },
                  proprioceptive: { label: 'Typical', name: 'proprioceptive', value: 3, observations: globalState.assessments.sensoryProfile.domains.proprioceptive?.observations },
                  oral: { label: 'Typical', name: 'oral', value: 3, observations: globalState.assessments.sensoryProfile.domains.oral?.observations }
                },
