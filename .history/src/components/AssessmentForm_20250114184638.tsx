        ...
        const sheetyResponse = await submitFormData({
          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                type: 'sensoryProfile',
                domains: Object.entries(globalState.assessments.sensoryProfile.domains).reduce((acc, [key, value]) => ({
                  ...acc,
                  [key]: {
                    label: key,
                    name: key,
                ...
                }), {} as Record<string, { label: string; name: string; value?: string; observations?: string }>),
                progress: globalState.assessments.sensoryProfile.progress,
                isComplete: globalState.assessments.sensoryProfile.isComplete
              },
              socialCommunication: {
                type: 'socialCommunication',
                domains: Object.entries(globalState.assessments.socialCommunication.domains).reduce((acc, [key, value]) => ({
                  ...acc,
                  [key]: {
                    label: key,
                    name: key,
              ...
              behaviorInterests: {
                ...
                domains: Object.entries(globalState.assessments.behaviorInterests.domains).reduce((acc, [key, value]) => ({
                  ...acc,
                  [key]: {
                    label: key,
                    name: key,
