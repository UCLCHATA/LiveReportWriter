...
import type { AssessmentData, GlobalState } from '../types';
...
export const AssessmentCarousel: React.FC<AssessmentCarouselProps> = ({ 
  ...
  // Initialize carousel state from saved form
  useEffect(() => {
    if (!globalState.chataId || isInitialized) return;

    console.log('[AssessmentCarousel] Initializing with CHATA ID:', globalState.chataId);
    console.log('[AssessmentCarousel] Current assessments:', globalState.assessments);
    ...
    console.log('[AssessmentCarousel] Initial completion states:', newStates);
    setCompletionStates(newStates);
    setIsInitialized(true);
  }, [globalState.chataId, isInitialized, globalState.assessments, calculateComponentProgress]);
  ...
  const handleComponentUpdate = (data: any) => {
    ...
    console.log('[AssessmentCarousel] Updating component:', componentId, data);
    ...
    if (componentId === 'milestones') {
      ...
      updateAssessments({ [componentId]: updatedData });
    } else {
      const updatedData = {
        ...data,
        type: componentId,
  ...
  useEffect(() => {
    ...
    console.log('[AssessmentCarousel] Updated completion states:', newStates);
    setCompletionStates(newStates);
  ...
  useEffect(() => {
    ...
    console.log('[AssessmentCarousel] Total progress:', totalProgress);
    onProgressUpdate(totalProgress);
  }, [completionStates, tools, onProgressUpdate]);

  useEffect(() => {
    if (typeof currentIndex === 'number') {
      updateAssessments({ currentStep: currentIndex });
    }
  }, [currentIndex, updateAssessments]);
