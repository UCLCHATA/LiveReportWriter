...
const TimelineViewer: React.FC<{ milestones: any }> = ({ milestones }) => {
  ...
  const placedMilestones = milestones.filter((m: any) => m.actualAge !== undefined);
  ...
  return (
    <div className={styles.timelineViewer}>
      ...
      <div className={styles.milestonesLayer}>
        {placedMilestones.map((milestone: any) => (
          <div
            key={milestone.id}
...
export const AssessmentSummary: React.FC<AssessmentSummaryProps> = ({ data, onChange }) => {
  return (
    <div className={styles.container}>
      ...
      />
      {data?.milestoneTracker?.milestones && (
