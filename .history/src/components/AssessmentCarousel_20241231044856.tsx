...
export const AssessmentCarousel: React.FC = () => {
  ...
  const handleComponentUpdate = (data: any) => {
    updateAssessment(tools[currentIndex].id as keyof typeof globalState.assessments, data);
  };
  ...
  return (
    <div className={styles.carouselContainer}>
      ...
      <div className={styles.carouselContent}>
        <CurrentComponent
          data={globalState.assessments[tools[currentIndex].id as keyof typeof globalState.assessments]}
