  ...
  const handleStatusChange = async (newStatus: 'draft' | 'submitted') => {
    if (newStatus === 'submitted') {
      try {
        ...
        setShowSuccessDialog(true); // Show success dialog after successful submission
      ...
      {showSuccessDialog && (
        <div className={styles.successDialogOverlay}>
          <div className={styles.successDialog}>
            <button className={styles.closeButton} onClick={handleCloseSuccessDialog}>
              <X size={24} />
            </button>
            <div className={styles.successContent}>
              ...
              <button className={styles.closeDialogButton} onClick={handleCloseSuccessDialog}>
                Close
              </button>
            </div>
          </div>
