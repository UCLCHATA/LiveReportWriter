...
import { NewAssessmentLogger } from './NewAssessmentLogger';
import { TestAssessmentGrid } from './TestAssessmentGrid';
...
const tools = [
  ...
  },
  {
    ...
    component: NewAssessmentLogger,
    description: 'Record and track assessment progress'
  },
  {
    id: 'test-grid',
    title: 'Test Grid',
    component: TestAssessmentGrid,
