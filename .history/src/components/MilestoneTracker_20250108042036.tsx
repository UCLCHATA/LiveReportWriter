...
const categoryMapping: { [key: string]: CategoryType } = {
  ...
  'motor': 'motor',
  'social': 'social',
  'communication': 'communication', // Add reverse mappings
  'concerns': 'concerns'
};
        ...
        <div className={styles.categoriesContainer}>
          {(Object.entries(categoryInfo) as [CategoryType, CategoryInfo][]).map(([category, info]) => {
            const categoryMilestones = milestones
              .filter((m: Milestone) => {
                const mappedCategory = categoryMapping[m.category] || m.category;
                ...
                <div className={styles.milestoneList}>
                  {categoryMilestones.map((milestone: Milestone) => (
                    <DraggableMilestone
                      ...
                      milestone={{
                        ...milestone,
                        category: categoryMapping[milestone.category] || milestone.category
                      }}
                      category={category}
            ...
            {activeMilestone && (
              <div 
                ...
                style={{ 
                  ...
                  backgroundColor: categoryInfo[categoryMapping[activeMilestone.category] || activeMilestone.category]?.color
                }}
              >
