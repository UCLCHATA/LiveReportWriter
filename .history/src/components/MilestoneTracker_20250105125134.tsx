...
const DraggableMilestone: React.FC<{ 
  ...
  data-tooltip?: string;
}> = ({ milestone, category, onCustomConcern, data-tooltip }) => {
  ...
  return (
    <motion.div
      ...
      data-early={isEarly}
      data-tooltip={data-tooltip || tooltipText}
      style={style}
              ...
              <div className={styles.milestoneList}>
                {milestones
                  .filter((m: Milestone) => 
                    m.category === category && 
                    !m.actualAge && 
                    (category === 'concerns' ? true : !m.id.startsWith('custom-concern-'))
                  )
                  .map((milestone: Milestone) => {
                    const tooltipText = categoryInfo[category as CategoryType].tooltips[milestone.title];
                    return (
                      <DraggableMilestone
                        key={milestone.id}
                        milestone={milestone}
