...
import { SubmissionOverlay, Stage, SubmissionDetails } from './SubmissionOverlay';
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const requiredFields = {
        'ASC Status': globalState.formData.ascStatus,
        'ADHD Status': globalState.formData.adhdStatus,
      ...
      setSubmissionDetails({
        ...
        emailStatus: 'Report will be sent to your email shortly'
      });
