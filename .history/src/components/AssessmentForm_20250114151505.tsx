      ...
      try {
        ...
        const sheetyData = {
          r3Form: {
            ...
            assessmentLogData: JSON.stringify({
              assessments: (globalState.assessments.assessmentLog.selectedAssessments as Assessment[]).map(assessment => {
                const entry = globalState.assessments.assessmentLog.entries[assessment.id];
                return {
