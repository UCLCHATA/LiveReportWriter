...
export const SocialCommunicationProfile: React.FC = () => {
  const [domains, setDomains] = useState<Domain[]>([
    { name: 'Joint Attention', value: 3, observations: [], label: 'Age Appropriate' },
    { name: 'Social Reciprocity', value: 3, observations: [], label: 'Age Appropriate' },
    { name: 'Verbal Communication', value: 3, observations: [], label: 'Age Appropriate' },
    { name: 'Non-verbal Communication', value: 3, observations: [], label: 'Age Appropriate' },
    { name: 'Social Understanding', value: 3, observations: [], label: 'Age Appropriate' },
    { name: 'Play Skills', value: 3, observations: [], label: 'Age Appropriate' },
  ]);
