...
interface SensoryDomain {
  ...
  observations: string[];
  label: 'Significantly Under-responsive' | 'Under-responsive' | 'Typical' | 'Over-responsive' | 'Significantly Over-responsive' | 'Skipped';
}
...
type SensoryLabel = 'Significantly Under-responsive' | 'Under-responsive' | 'Typical' | 'Over-responsive' | 'Significantly Over-responsive' | 'Skipped';

const getSensitivityLabel = (value: number | undefined): SensoryLabel => {
...
export const SensoryProfileBuilder: React.FC<SensoryProfileBuilderProps> = ({ data, onChange }) => {
  ...
  useEffect(() => {
    if (!data?.domains) {
      onChange({
        domains: {
          visual: { name: 'Visual', value: undefined, observations: [], label: 'Skipped' },
          auditory: { name: 'Auditory', value: undefined, observations: [], label: 'Skipped' },
          tactile: { name: 'Tactile', value: undefined, observations: [], label: 'Skipped' },
          vestibular: { name: 'Vestibular', value: undefined, observations: [], label: 'Skipped' },
          proprioceptive: { name: 'Proprioceptive', value: undefined, observations: [], label: 'Skipped' },
          oral: { name: 'Oral', value: undefined, observations: [], label: 'Skipped' },
        }
      });
    }
  }, [data, onChange]);
