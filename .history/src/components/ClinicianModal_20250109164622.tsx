...
const formService = new FormPersistenceService();
...
export const ClinicianModal: React.FC<ClinicianModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (clinicianInfo.name && clinicianInfo.email && clinicianInfo.clinicName) {
      ...
      const existingForm = formService.getFormByClinicianAndChild(
        clinicianInfo.name,
  ...
  const handleChataIdSubmit = () => {
    ...
    const existingForm = formService.getForm(chataIdInput);
    if (!existingForm) {
