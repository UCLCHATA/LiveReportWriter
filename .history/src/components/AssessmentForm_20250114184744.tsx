          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                type: 'sensoryProfile',
                domains: {
                  visual: { label: 'Typical', name: 'visual', ...globalState.assessments.sensoryProfile.domains.visual },
                  auditory: { label: 'Typical', name: 'auditory', ...globalState.assessments.sensoryProfile.domains.auditory },
                  tactile: { label: 'Typical', name: 'tactile', ...globalState.assessments.sensoryProfile.domains.tactile },
                  vestibular: { label: 'Typical', name: 'vestibular', ...globalState.assessments.sensoryProfile.domains.vestibular },
                  proprioceptive: { label: 'Typical', name: 'proprioceptive', ...globalState.assessments.sensoryProfile.domains.proprioceptive },
                  oral: { label: 'Typical', name: 'oral', ...globalState.assessments.sensoryProfile.domains.oral }
                },
              ...
              socialCommunication: {
                ...
                domains: {
                  jointAttention: { label: 'Age Appropriate', name: 'jointAttention', ...globalState.assessments.socialCommunication.domains.jointAttention },
                  nonverbalCommunication: { label: 'Age Appropriate', name: 'nonverbalCommunication', ...globalState.assessments.socialCommunication.domains.nonverbalCommunication },
                  verbalCommunication: { label: 'Age Appropriate', name: 'verbalCommunication', ...globalState.assessments.socialCommunication.domains.verbalCommunication },
                  socialUnderstanding: { label: 'Age Appropriate', name: 'socialUnderstanding', ...globalState.assessments.socialCommunication.domains.socialUnderstanding },
                  playSkills: { label: 'Age Appropriate', name: 'playSkills', ...globalState.assessments.socialCommunication.domains.playSkills },
                  peerInteractions: { label: 'Age Appropriate', name: 'peerInteractions', ...globalState.assessments.socialCommunication.domains.peerInteractions }
                },
              ...
              behaviorInterests: {
                ...
                domains: {
                  repetitiveBehaviors: { label: 'Not Present', name: 'repetitiveBehaviors', ...globalState.assessments.behaviorInterests.domains.repetitiveBehaviors },
                  routinesRituals: { label: 'Not Present', name: 'routinesRituals', ...globalState.assessments.behaviorInterests.domains.routinesRituals },
                  specialInterests: { label: 'Not Present', name: 'specialInterests', ...globalState.assessments.behaviorInterests.domains.specialInterests },
                  sensoryInterests: { label: 'Not Present', name: 'sensoryInterests', ...globalState.assessments.behaviorInterests.domains.sensoryInterests },
                  emotionalRegulation: { label: 'Not Present', name: 'emotionalRegulation', ...globalState.assessments.behaviorInterests.domains.emotionalRegulation },
                  flexibility: { label: 'Not Present', name: 'flexibility', ...globalState.assessments.behaviorInterests.domains.flexibility }
                },
