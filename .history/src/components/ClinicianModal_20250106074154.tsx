...
export const ClinicianModal: React.FC<ClinicianModalProps> = ({
  ...
  const handleChataIdSubmit = () => {
    // Normalize the CHATA ID to uppercase
    const normalizedChataId = chataIdInput.toUpperCase();
    console.log('Attempting to retrieve form with CHATA ID:', normalizedChataId);
    
    if (!validateChataId(normalizedChataId)) {
      setChataIdError('Invalid CHATA ID format (e.g., XXX-XXX-766)');
      return;
    }
  ...
  const retrievalOverlay = showRetrievalOverlay && (
    <div className={styles.blurryOverlay}>
      <div className={styles.dialogContent}>
        ...
        <p>Enter your CHATA ID to retrieve an existing form:</p>
