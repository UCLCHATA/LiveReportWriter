...
const getDomainTooltip = (domain: string): string => {
  switch (domain) {
    case 'Joint Attention':
      return 'Assess ability to:\n• Share focus with others\n• Follow & direct attention\n• Show & point to objects\n• Engage in social referencing';
    case 'Social Reciprocity':
      return 'Evaluate capacity for:\n• Back-and-forth interaction\n• Social initiation & response\n• Emotional give-and-take\n• Sharing of interests';
    case 'Verbal Communication':
      return 'Rate proficiency in:\n• Conversational exchange\n• Language comprehension\n• Expression of needs/thoughts\n• Speech patterns/prosody';
    case 'Non-verbal Communication':
      return 'Assess use of:\n• Eye contact\n• Facial expressions\n• Gestures\n• Body language';
    case 'Social Understanding':
      return 'Evaluate grasp of:\n• Social cues/context\n• Peer relationships\n• Emotional recognition\n• Social boundaries';
    case 'Play Skills':
      return 'Rate ability in:\n• Imaginative play\n• Peer interaction in play\n• Game rule understanding\n• Play flexibility';
    default:
