...
const MilestoneTracker: React.FC<MilestoneTrackerProps> = ({
  ...
  return (
    <div className="milestone-tracker bg-white rounded-lg shadow-sm p-6">
      <div className="controls flex gap-4 mb-5">
        <select 
      ...
      <div ref={timelineRef} className="timeline-container border border-gray-200 rounded-md mb-5" />
      
      {state.selectedMilestone && (
        <div className="milestone-details bg-gray-50 rounded-md p-5 border border-gray-200">
          <h3 className="text-lg font-medium text-gray-900 mb-4">
            {state.selectedMilestone.description}
          </h3>
          <div className="milestone-info grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
            <div>
          ...
          <textarea
            ...
            className="w-full min-h-[100px] p-3 rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500"
          />
        </div>
      )}
    </div>
