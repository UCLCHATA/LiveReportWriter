...
const ICFDomainRadar = ({ completedAssessments, icfCategories }) => {
...
// Timeline Component
const AssessmentTimeline = ({ completedAssessments }) => {
...
export const AssessmentLog: React.FC = () => {
  ...
  const handleAssessmentComplete = (assessment, details) => {
