  ...
  useEffect(() => {
    ...
    if (newProgress !== lastProgress.current) {
      ...
      console.log('Form Progress Breakdown:', {
        textFields: {
          clinicalObservations: getWordCountState(globalState.formData?.clinicalObservations || ''),
          strengthsAbilities: getWordCountState(globalState.formData?.strengths || ''),
          prioritySupportAreas: getWordCountState(globalState.formData?.priorityAreas || ''),
          supportRecommendations: getWordCountState(globalState.formData?.recommendations || '')
        },
        status: {
    ...
    return (
      <div className={styles.submitContainer}>
        <div className={styles.bottom}>
          <div className={`${styles.text} ${styles.textDark}`}>Submit</div>
        </div>
        <div className={styles.cover}>
          ...
          <div className={styles.textContainer}>
            <div className={`${styles.text} ${styles.textCut}`}>Submit</div>
          </div>
        </div>
        <div className={styles.overlay} onClick={() => handleStatusChange('submitted')} />
      </div>
    );
  };
