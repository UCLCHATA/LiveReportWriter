...
export const AssessmentCarousel: React.FC<AssessmentCarouselProps> = ({ onProgressUpdate }) => {
  ...
  const handleTooltipPosition = (e: React.MouseEvent<HTMLButtonElement>) => {
    const tooltip = e.currentTarget.querySelector(`.${styles.toolkitTooltip}`) as HTMLElement;
    if (tooltip) {
              ...
              <h2 className={styles.title}>
                ...
                >
                  ...
                  <div className={styles.toolkitTooltip}>
                    {getTooltipContent(tools[currentIndex].title)}
                  </div>
                </button>
              </h2>
            </div>
