      ...
      {showConfirm && (
        <div className={styles.confirmDialog}>
          <div className={styles.confirmContent}>
            <h2 className={styles.confirmTitle}>Submit Assessment</h2>
            <p className={styles.confirmMessage}>
              Are you ready to submit this assessment? Our AI will analyze your input and generate a comprehensive report.
            </p>
