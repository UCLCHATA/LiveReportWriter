                ...
                domains: {
                  visual: { 
                    label: getSliderLabel({ 
                      label: globalState.assessments.sensoryProfile.domains.visual?.label as SensoryLabel,
                      value: getDomainValue(globalState.assessments.sensoryProfile.domains.visual?.value)
                    }), 
                    name: 'visual', 
                    value: getDomainValue(globalState.assessments.sensoryProfile.domains.visual?.value),
                    observations: getObservations(globalState.assessments.sensoryProfile.domains.visual?.observations)
                  },
                  auditory: { 
                    label: getSliderLabel({ 
                      label: globalState.assessments.sensoryProfile.domains.auditory?.label as SensoryLabel,
                      value: getDomainValue(globalState.assessments.sensoryProfile.domains.auditory?.value)
                    }),
                    name: 'auditory',
                    value: getDomainValue(globalState.assessments.sensoryProfile.domains.auditory?.value),
                    observations: getObservations(globalState.assessments.sensoryProfile.domains.auditory?.observations)
                  },
                  tactile: { 
                    label: getSliderLabel({ 
