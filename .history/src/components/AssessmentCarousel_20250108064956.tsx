    ...
    switch (componentId) {
      ...
      case 'behaviorInterests':
        if (isBaseAssessment(currentAssessment)) {
          ...
          // Preserve existing labels when updating
          if (baseData.domains) {
            Object.keys(baseData.domains).forEach(key => {
              if (currentAssessment.domains[key]) {
                baseData.domains[key].label = currentAssessment.domains[key].label;
              }
            });
          }
