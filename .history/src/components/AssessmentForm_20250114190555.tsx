          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                ...
                domains: {
                  visual: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.visual), 
                    name: 'visual', 
                    value: globalState.assessments.sensoryProfile.domains.visual?.value || 3, 
                    observations: globalState.assessments.sensoryProfile.domains.visual?.observations || [] 
                  },
                  auditory: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.auditory),
                    name: 'auditory',
                    value: globalState.assessments.sensoryProfile.domains.auditory?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.auditory?.observations || []
                  },
                  tactile: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.tactile),
                    name: 'tactile',
                    value: globalState.assessments.sensoryProfile.domains.tactile?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.tactile?.observations || []
                  },
                  vestibular: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.vestibular),
                    name: 'vestibular',
                    value: globalState.assessments.sensoryProfile.domains.vestibular?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.vestibular?.observations || []
                  },
                  proprioceptive: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.proprioceptive),
                    name: 'proprioceptive',
                    value: globalState.assessments.sensoryProfile.domains.proprioceptive?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.proprioceptive?.observations || []
                  },
                  oral: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.oral),
                    name: 'oral',
                    value: globalState.assessments.sensoryProfile.domains.oral?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.oral?.observations || []
                  }
                },
