...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ 
  ...
  useEffect(() => {
    const calculateProgress = () => {
      ...
      // Status and referrals contribute 10% total
      // Status fields contribute 6% (3% each)
      ...
      // Professional referrals contribute 4%
  ...
  }, [globalState.formData, initialProgress, onProgressUpdate]);
