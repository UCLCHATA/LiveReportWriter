...
const getDomainValue = (value: string | number | undefined): number | undefined => {
...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ 
  ...
  const [submissionStage, setSubmissionStage] = useState<'submission' | 'waiting' | 'complete' | 'error'>('submission');
