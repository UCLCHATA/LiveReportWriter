    ...
    if (newStatus === 'submitted') {
      try {
        ...
        if (insufficientDetailFields.length > 0) {
          console.log('❌ Validation failed - Insufficient detail in fields:', insufficientDetailFields);
          alert(`Please provide more detail (at least "Good Detail" level) for the following fields:\n${insufficientDetailFields.join('\n')}`);
          return;
        }

        console.log('✓ All text fields have sufficient detail');
        ...
        if (window.location.hostname === 'localhost') {
          ...
          console.log('✓ Local submission simulation complete - success dialog should appear');
          return;
        }
        ...
        setSubmissionStage('complete');
        setShowSuccessDialog(true);
        console.log('✓ Form submission completed successfully - success dialog should appear');
