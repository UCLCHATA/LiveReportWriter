          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                ...
                domains: {
                  visual: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.visual) as SensoryLabel, 
                    name: 'visual', 
                    value: Number(globalState.assessments.sensoryProfile.domains.visual?.value ?? 3), 
                    observations: Array.isArray(globalState.assessments.sensoryProfile.domains.visual?.observations) 
                      ? globalState.assessments.sensoryProfile.domains.visual.observations 
                      : []
                  },
                  auditory: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.auditory) as SensoryLabel,
                    name: 'auditory',
                    value: Number(globalState.assessments.sensoryProfile.domains.auditory?.value ?? 3),
                    observations: Array.isArray(globalState.assessments.sensoryProfile.domains.auditory?.observations) 
                      ? globalState.assessments.sensoryProfile.domains.auditory.observations 
                      : []
                  },
                  tactile: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.tactile) as SensoryLabel,
                    name: 'tactile',
                    value: Number(globalState.assessments.sensoryProfile.domains.tactile?.value ?? 3),
                    observations: Array.isArray(globalState.assessments.sensoryProfile.domains.tactile?.observations) 
                      ? globalState.assessments.sensoryProfile.domains.tactile.observations 
                      : []
                  },
                  vestibular: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.vestibular) as SensoryLabel,
                    name: 'vestibular',
                    value: Number(globalState.assessments.sensoryProfile.domains.vestibular?.value ?? 3),
                    observations: Array.isArray(globalState.assessments.sensoryProfile.domains.vestibular?.observations) 
                      ? globalState.assessments.sensoryProfile.domains.vestibular.observations 
                      : []
                  },
                  proprioceptive: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.proprioceptive) as SensoryLabel,
                    name: 'proprioceptive',
                    value: Number(globalState.assessments.sensoryProfile.domains.proprioceptive?.value ?? 3),
                    observations: Array.isArray(globalState.assessments.sensoryProfile.domains.proprioceptive?.observations) 
                      ? globalState.assessments.sensoryProfile.domains.proprioceptive.observations 
                      : []
                  },
                  oral: { 
                    label: getSliderLabel(globalState.assessments.sensoryProfile.domains.oral) as SensoryLabel,
                    name: 'oral',
                    value: Number(globalState.assessments.sensoryProfile.domains.oral?.value ?? 3),
                    observations: Array.isArray(globalState.assessments.sensoryProfile.domains.oral?.observations) 
                      ? globalState.assessments.sensoryProfile.domains.oral.observations 
                      : []
                  }
                },
              ...
              socialCommunication: {
                ...
                domains: {
                  jointAttention: { label: 'Age Appropriate', name: 'jointAttention', value: 5, observations: globalState.assessments.socialCommunication.domains.jointAttention?.observations || [] },
                  nonverbalCommunication: { label: 'Age Appropriate', name: 'nonverbalCommunication', value: 5, observations: globalState.assessments.socialCommunication.domains.nonverbalCommunication?.observations || [] },
                  verbalCommunication: { label: 'Age Appropriate', name: 'verbalCommunication', value: 5, observations: globalState.assessments.socialCommunication.domains.verbalCommunication?.observations || [] },
                  socialUnderstanding: { label: 'Age Appropriate', name: 'socialUnderstanding', value: 5, observations: globalState.assessments.socialCommunication.domains.socialUnderstanding?.observations || [] },
                  playSkills: { label: 'Age Appropriate', name: 'playSkills', value: 5, observations: globalState.assessments.socialCommunication.domains.playSkills?.observations || [] },
                  peerInteractions: { label: 'Age Appropriate', name: 'peerInteractions', value: 5, observations: globalState.assessments.socialCommunication.domains.peerInteractions?.observations || [] }
                },
              ...
              behaviorInterests: {
                ...
                domains: {
                  repetitiveBehaviors: { label: 'Not Present', name: 'repetitiveBehaviors', value: 1, observations: globalState.assessments.behaviorInterests.domains.repetitiveBehaviors?.observations || [] },
                  routinesRituals: { label: 'Not Present', name: 'routinesRituals', value: 1, observations: globalState.assessments.behaviorInterests.domains.routinesRituals?.observations || [] },
                  specialInterests: { label: 'Not Present', name: 'specialInterests', value: 1, observations: globalState.assessments.behaviorInterests.domains.specialInterests?.observations || [] },
                  sensoryInterests: { label: 'Not Present', name: 'sensoryInterests', value: 1, observations: globalState.assessments.behaviorInterests.domains.sensoryInterests?.observations || [] },
                  emotionalRegulation: { label: 'Not Present', name: 'emotionalRegulation', value: 1, observations: globalState.assessments.behaviorInterests.domains.emotionalRegulation?.observations || [] },
                  flexibility: { label: 'Not Present', name: 'flexibility', value: 1, observations: globalState.assessments.behaviorInterests.domains.flexibility?.observations || [] }
                },
