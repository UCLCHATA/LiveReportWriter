...
export const MilestoneTracker: React.FC = () => {
  ...
  const handleDragEnd = (result: DropResult) => {
    ...
    // The timeline is divided into maxAge + 1 segments (0 to maxAge months)
    // The index in the destination represents the month
  ...
  // Create droppable slots for each month on the timeline
  const timelineSlots = Array.from({ length: maxAge + 1 }, (_, i) => i);
