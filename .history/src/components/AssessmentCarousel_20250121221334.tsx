...
export const AssessmentCarousel: React.FC<AssessmentCarouselProps> = React.memo(({
  ...
  }, [updateAssessment, globalState.assessments]);
  ...
  }, [updateAssessment, calculateProgress, globalState.assessments]);
  ...
  }, [currentIndex, globalState.assessments, calculateProgress, completionStates]);
