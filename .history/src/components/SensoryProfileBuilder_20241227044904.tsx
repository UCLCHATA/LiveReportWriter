...
export const SensoryProfileBuilder: React.FC = () => {
  ...
  return (
    <div className="sensory-profile" style={{ height: '100%', display: 'flex', flexDirection: 'column' }}>      
      <div className="profile-content" style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        <div className="radar-container" style={{ flexShrink: 0 }}>
        ...
        <div className="sliders-grid" style={{ overflowY: 'auto', flex: 1, marginTop: '0.5rem' }}>
