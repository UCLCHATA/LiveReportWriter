      ...
      try {
        ...
        if (combinedRadarChart) {
          ...
          const response = await fetch(R3_FORM_API, {
            ...
            body: JSON.stringify({
              r3Form: {
                chataId: globalState.clinicianInfo?.chataId,
                name: globalState.clinicianInfo?.childName,
          ...
          // Template stage
          const templateResult = await makeAppsScriptCall(APPS_SCRIPT_URLS.template, globalState.clinicianInfo?.chataId);
          ...
          // Analysis stage
          const analysisResult = await makeAppsScriptCall(APPS_SCRIPT_URLS.analysis, globalState.clinicianInfo?.chataId);
          ...
          const result = await makeAppsScriptCall(APPS_SCRIPT_URLS.report, globalState.clinicianInfo?.chataId);
