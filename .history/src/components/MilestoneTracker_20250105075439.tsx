...
const categoryInfo: CategoryInfoMap = {
  ...
  concerns: {
    ...
    color: '#9F7AEA',
    tooltips: {
      'Unusual responses': 'Strong reactions to everyday sounds, textures, or lights; covering ears; avoiding certain clothes or foods',
      'Repetitive movements': 'Hand-flapping, spinning, or rocking when excited or stressed; lining up toys repeatedly',
      'Social differences': 'Prefers to play alone; difficulty with back-and-forth interaction; reduced eye contact'
    }
  }
};
...
const DraggableMilestone: React.FC<{ 
  ...
  const tooltipText = milestone.actualAge !== undefined 
    ...
    : milestone.id === 'custom-concern' ? 'Add custom concern' : undefined;
