...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ 
  ...
  useEffect(() => {
    console.log('AssessmentForm: Initial mount with CHATA ID:', chataId);
    if (chataId) {
      setChataId(chataId);
    }
  }, [chataId, setChataId]); // Depend on chataId and setChataId

  // Initialize form state with default values
  useEffect(() => {
    if (!globalState.formData) {
      console.log('AssessmentForm: Initializing default form state');
      updateFormData({
        status: 'draft',
        ascStatus: '',
        adhdStatus: '',
  ...
  useEffect(() => {
    if (chataId) {
      ...
      if (savedForm?.formState) {
        ...
        const formState = savedForm.formState;
        console.log('AssessmentForm: Restoring form with state:', formState);
  ...
  }, [chataId, updateFormData]); // Add updateFormData to dependencies
