    ...
    if (newStatus === 'submitted') {
      ...
      try {
        ...
        const sheetyResponse = await submitFormData({
          formData: {
            ...formData,
            milestones: globalState.assessments.milestones?.milestones as Milestone[],
          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                type: 'sensoryProfile',
                domains: globalState.assessments.sensoryProfile.domains as unknown as {
                  visual: { value?: string; observations?: string };
                  auditory: { value?: string; observations?: string };
                  tactile: { value?: string; observations?: string };
                  vestibular: { value?: string; observations?: string };
                  proprioceptive: { value?: string; observations?: string };
                  oral: { value?: string; observations?: string };
                },
              ...
              socialCommunication: {
                ...
                domains: globalState.assessments.socialCommunication.domains as unknown as {
                  jointAttention: { value?: string; observations?: string };
                  nonverbalCommunication: { value?: string; observations?: string };
                  verbalCommunication: { value?: string; observations?: string };
                  socialUnderstanding: { value?: string; observations?: string };
                  playSkills: { value?: string; observations?: string };
                  peerInteractions: { value?: string; observations?: string };
                },
              ...
              behaviorInterests: {
                ...
                domains: globalState.assessments.behaviorInterests.domains as unknown as {
                  repetitiveBehaviors: { value?: string; observations?: string };
                  routinesRituals: { value?: string; observations?: string };
                  specialInterests: { value?: string; observations?: string };
                  sensoryInterests: { value?: string; observations?: string };
                  emotionalRegulation: { value?: string; observations?: string };
                  flexibility: { value?: string; observations?: string };
                },
