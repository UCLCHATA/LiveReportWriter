...
const categoryMapping: Record<DataCategoryType, CategoryType> = {
...
// Type guard to check if a category is a UI category
const isUICategory = (category: DataCategoryType): category is CategoryType => {
  return ['communication', 'motor', 'social', 'concerns'].includes(category);
};

// Helper function to safely map categories with type guard
const mapCategory = (category: DataCategoryType): CategoryType => {
  if (isUICategory(category)) {
    return category;
  }
        ...
        <div className={styles.categoriesContainer}>
          {(Object.entries(categoryInfo) as [CategoryType, CategoryInfo][]).map(([category, info]) => {
            ...
            console.log(`Rendering category ${category}:`, { 
              title: info.title, 
              milestonesCount: categoryMilestones.length,
