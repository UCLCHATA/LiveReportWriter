...
export const BehaviorInterestsProfile: React.FC = () => {
  const [domains, setDomains] = useState<Domain[]>([
    { name: 'Repetitive Behaviors', value: 1, observations: [] },
    { name: 'Restricted Interests', value: 1, observations: [] },
    { name: 'Sensory Seeking', value: 1, observations: [] },
    { name: 'Routine Adherence', value: 1, observations: [] },
    { name: 'Flexibility', value: 1, observations: [] },
    { name: 'Activity Transitions', value: 1, observations: [] },
  ]);
