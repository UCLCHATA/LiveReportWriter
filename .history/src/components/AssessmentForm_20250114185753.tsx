          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                ...
                domains: {
                  visual: { 
                    label: `${globalState.assessments.sensoryProfile.domains.visual?.label} (${globalState.assessments.sensoryProfile.domains.visual?.value}/5)`, 
                    name: 'visual', 
                    value: globalState.assessments.sensoryProfile.domains.visual?.value || 3, 
                    observations: globalState.assessments.sensoryProfile.domains.visual?.observations ? [globalState.assessments.sensoryProfile.domains.visual.observations] : [] 
                  },
                  auditory: { 
                    label: `${globalState.assessments.sensoryProfile.domains.auditory?.label} (${globalState.assessments.sensoryProfile.domains.auditory?.value}/5)`,
                    name: 'auditory',
                    value: globalState.assessments.sensoryProfile.domains.auditory?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.auditory?.observations ? [globalState.assessments.sensoryProfile.domains.auditory.observations] : []
                  },
                  tactile: { 
                    label: `${globalState.assessments.sensoryProfile.domains.tactile?.label} (${globalState.assessments.sensoryProfile.domains.tactile?.value}/5)`,
                    name: 'tactile',
                    value: globalState.assessments.sensoryProfile.domains.tactile?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.tactile?.observations ? [globalState.assessments.sensoryProfile.domains.tactile.observations] : []
                  },
                  vestibular: { 
                    label: `${globalState.assessments.sensoryProfile.domains.vestibular?.label} (${globalState.assessments.sensoryProfile.domains.vestibular?.value}/5)`,
                    name: 'vestibular',
                    value: globalState.assessments.sensoryProfile.domains.vestibular?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.vestibular?.observations ? [globalState.assessments.sensoryProfile.domains.vestibular.observations] : []
                  },
                  proprioceptive: { 
                    label: `${globalState.assessments.sensoryProfile.domains.proprioceptive?.label} (${globalState.assessments.sensoryProfile.domains.proprioceptive?.value}/5)`,
                    name: 'proprioceptive',
                    value: globalState.assessments.sensoryProfile.domains.proprioceptive?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.proprioceptive?.observations ? [globalState.assessments.sensoryProfile.domains.proprioceptive.observations] : []
                  },
                  oral: { 
                    label: `${globalState.assessments.sensoryProfile.domains.oral?.label} (${globalState.assessments.sensoryProfile.domains.oral?.value}/5)`,
                    name: 'oral',
                    value: globalState.assessments.sensoryProfile.domains.oral?.value || 3,
                    observations: globalState.assessments.sensoryProfile.domains.oral?.observations ? [globalState.assessments.sensoryProfile.domains.oral.observations] : []
                  }
                },
              ...
              socialCommunication: {
                ...
                domains: {
                  jointAttention: { label: 'Age Appropriate', name: 'jointAttention', value: 5, observations: globalState.assessments.socialCommunication.domains.jointAttention?.observations ? [globalState.assessments.socialCommunication.domains.jointAttention.observations] : [] },
                  nonverbalCommunication: { label: 'Age Appropriate', name: 'nonverbalCommunication', value: 5, observations: globalState.assessments.socialCommunication.domains.nonverbalCommunication?.observations ? [globalState.assessments.socialCommunication.domains.nonverbalCommunication.observations] : [] },
                  verbalCommunication: { label: 'Age Appropriate', name: 'verbalCommunication', value: 5, observations: globalState.assessments.socialCommunication.domains.verbalCommunication?.observations ? [globalState.assessments.socialCommunication.domains.verbalCommunication.observations] : [] },
                  socialUnderstanding: { label: 'Age Appropriate', name: 'socialUnderstanding', value: 5, observations: globalState.assessments.socialCommunication.domains.socialUnderstanding?.observations ? [globalState.assessments.socialCommunication.domains.socialUnderstanding.observations] : [] },
                  playSkills: { label: 'Age Appropriate', name: 'playSkills', value: 5, observations: globalState.assessments.socialCommunication.domains.playSkills?.observations ? [globalState.assessments.socialCommunication.domains.playSkills.observations] : [] },
                  peerInteractions: { label: 'Age Appropriate', name: 'peerInteractions', value: 5, observations: globalState.assessments.socialCommunication.domains.peerInteractions?.observations ? [globalState.assessments.socialCommunication.domains.peerInteractions.observations] : [] }
                },
              ...
              behaviorInterests: {
                ...
                domains: {
                  repetitiveBehaviors: { label: 'Not Present', name: 'repetitiveBehaviors', value: 1, observations: globalState.assessments.behaviorInterests.domains.repetitiveBehaviors?.observations ? [globalState.assessments.behaviorInterests.domains.repetitiveBehaviors.observations] : [] },
                  routinesRituals: { label: 'Not Present', name: 'routinesRituals', value: 1, observations: globalState.assessments.behaviorInterests.domains.routinesRituals?.observations ? [globalState.assessments.behaviorInterests.domains.routinesRituals.observations] : [] },
                  specialInterests: { label: 'Not Present', name: 'specialInterests', value: 1, observations: globalState.assessments.behaviorInterests.domains.specialInterests?.observations ? [globalState.assessments.behaviorInterests.domains.specialInterests.observations] : [] },
                  sensoryInterests: { label: 'Not Present', name: 'sensoryInterests', value: 1, observations: globalState.assessments.behaviorInterests.domains.sensoryInterests?.observations ? [globalState.assessments.behaviorInterests.domains.sensoryInterests.observations] : [] },
                  emotionalRegulation: { label: 'Not Present', name: 'emotionalRegulation', value: 1, observations: globalState.assessments.behaviorInterests.domains.emotionalRegulation?.observations ? [globalState.assessments.behaviorInterests.domains.emotionalRegulation.observations] : [] },
                  flexibility: { label: 'Not Present', name: 'flexibility', value: 1, observations: globalState.assessments.behaviorInterests.domains.flexibility?.observations ? [globalState.assessments.behaviorInterests.domains.flexibility.observations] : [] }
                },
              ...
              milestones: {
                ...
                lastUpdated: globalState.assessments.milestones.lastUpdated
              },
              summary: {
                type: 'summary',
                progress: 100,
