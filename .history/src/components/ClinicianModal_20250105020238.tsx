          ...
          <div className={styles.alertContent}>
            ...
            <div className={styles.chataIdInput}>
              <input
                ...
                placeholder="Enter CHATA ID (e.g., JS-UC-123)"
              />
      ...
      {showChataIdInfo && (
        <div className={styles.modalOverlay}>
          <div className={styles.alertContent}>
            ...
            <p>
              Please write down your CHATA ID. You'll need this to retrieve your form if you need to continue later:
            </p>
            ...
            <p className={styles.chataIdNote}>
              This ID combines your initials, clinic name, and a unique number.
              Keep it safe - you'll need it to resume your assessment if needed.
            </p>
            <div className={styles.buttonGroup}>
              <button
