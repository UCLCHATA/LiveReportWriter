    ...
    <div className={styles['milestone-tracker-container']}>
      <div className={styles['milestone-header']}>
        ...
        <div className={styles['tooltip-wrapper']}>
          ...
          <div className={styles['tooltip-content']}>{tooltipText.main}</div>
        </div>
      </div>
              ...
              {categoryMilestones.map(milestone => (
                ...
                >
                  ...
                  {milestone.actualAge !== null && (
                    <span className={styles['milestone-age']}>{milestone.actualAge}m</span>
                  )}
                  {milestone.actualAge === null && (
                    <span className={styles['milestone-expected']}>Expected: {milestone.expectedAge}m</span>
                  )}
                </div>
              ))}
            </div>
