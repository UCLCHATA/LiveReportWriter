    ...
    try {
      if (!includeInReport) {
        ...
        if (wrapperRef.current) {
          ...
          try {
            // Generate image using existing helper
            ...
            // Use existing chunking mechanism
            console.log('[MilestoneTracker] Chunking image data');
            const chunks = chunkImageData(base64Data);
