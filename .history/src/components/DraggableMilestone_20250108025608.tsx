...
export const DraggableMilestone: React.FC<DraggableMilestoneProps> = ({ 
  ...
  return (
    <motion.div
      ref={setNodeRef}
      style={style}
      className={`${styles.milestone} ${milestone.actualAge !== undefined ? styles.placedMilestone : ''} ${isEditing ? styles.active : ''}`}
        ...
        <>
          ...
          {milestone.actualAge !== undefined && milestone.expectedAge !== 0 && (
            <div 
              ...
              data-early={isEarly}
            >
              <span className={`${styles.monthText} ${isHovered ? styles.showDifference : ''}`} data-delayed={isDelayed} data-early={isEarly}>
