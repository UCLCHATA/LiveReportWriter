...
const getSensitivityLabel = (value: number | undefined): SensoryLabel => {
  if (value === undefined) return { label: 'Skipped' };
  switch (value) {
    case 1: return { label: 'Significantly Under-responsive' };
    case 2: return { label: 'Under-responsive' };
    case 3: return { label: 'Typical' };
    case 4: return { label: 'Over-responsive' };
    case 5: return { label: 'Significantly Over-responsive' };
    default: return { label: 'Skipped' };
  }
};
