...
interface Domain {
  ...
  observations: string[];
  label: 'Age Appropriate' | 'Subtle Differences' | 'Emerging' | 'Limited' | 'Significantly Limited' | 'Skipped';
}
...
type SocialCommunicationLabel = 'Age Appropriate' | 'Subtle Differences' | 'Emerging' | 'Limited' | 'Significantly Limited' | 'Skipped';

const getSensitivityLabel = (value: number | undefined): SocialCommunicationLabel => {
...
export const SocialCommunicationProfile: React.FC<SocialCommunicationProfileProps> = ({ data, onChange }) => {
  ...
  useEffect(() => {
    if (!data?.domains) {
      onChange({
        domains: {
          jointAttention: { name: 'Joint Attention', value: undefined, observations: [], label: 'Skipped' },
          socialReciprocity: { name: 'Social Reciprocity', value: undefined, observations: [], label: 'Skipped' },
          verbalCommunication: { name: 'Verbal Communication', value: undefined, observations: [], label: 'Skipped' },
          nonverbalCommunication: { name: 'Non-verbal Communication', value: undefined, observations: [], label: 'Skipped' },
          socialUnderstanding: { name: 'Social Understanding', value: undefined, observations: [], label: 'Skipped' },
          playSkills: { name: 'Play Skills', value: undefined, observations: [], label: 'Skipped' },
        }
      });
    }
  }, [data, onChange]);
