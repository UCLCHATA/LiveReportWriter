...
export const AssessmentForm: React.FC<AssessmentFormProps> = ({ onClear, onProgressUpdate, initialProgress }) => {
  const { globalState, updateFormData, clearState, setGlobalState } = useFormState();
