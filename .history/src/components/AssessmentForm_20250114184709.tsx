          ...
          globalState: {
            ...
            assessments: {
              sensoryProfile: {
                type: 'sensoryProfile',
                domains: {
                  visual: { label: 'Visual', name: 'visual', ...globalState.assessments.sensoryProfile.domains.visual },
                  auditory: { label: 'Auditory', name: 'auditory', ...globalState.assessments.sensoryProfile.domains.auditory },
                  tactile: { label: 'Tactile', name: 'tactile', ...globalState.assessments.sensoryProfile.domains.tactile },
                  vestibular: { label: 'Vestibular', name: 'vestibular', ...globalState.assessments.sensoryProfile.domains.vestibular },
                  proprioceptive: { label: 'Proprioceptive', name: 'proprioceptive', ...globalState.assessments.sensoryProfile.domains.proprioceptive },
                  oral: { label: 'Oral', name: 'oral', ...globalState.assessments.sensoryProfile.domains.oral }
                },
              ...
              socialCommunication: {
                ...
                domains: {
                  jointAttention: { label: 'Joint Attention', name: 'jointAttention', ...globalState.assessments.socialCommunication.domains.jointAttention },
                  nonverbalCommunication: { label: 'Nonverbal Communication', name: 'nonverbalCommunication', ...globalState.assessments.socialCommunication.domains.nonverbalCommunication },
                  verbalCommunication: { label: 'Verbal Communication', name: 'verbalCommunication', ...globalState.assessments.socialCommunication.domains.verbalCommunication },
                  socialUnderstanding: { label: 'Social Understanding', name: 'socialUnderstanding', ...globalState.assessments.socialCommunication.domains.socialUnderstanding },
                  playSkills: { label: 'Play Skills', name: 'playSkills', ...globalState.assessments.socialCommunication.domains.playSkills },
                  peerInteractions: { label: 'Peer Interactions', name: 'peerInteractions', ...globalState.assessments.socialCommunication.domains.peerInteractions }
                },
              ...
              behaviorInterests: {
                ...
                domains: {
                  repetitiveBehaviors: { label: 'Repetitive Behaviors', name: 'repetitiveBehaviors', ...globalState.assessments.behaviorInterests.domains.repetitiveBehaviors },
                  routinesRituals: { label: 'Routines & Rituals', name: 'routinesRituals', ...globalState.assessments.behaviorInterests.domains.routinesRituals },
                  specialInterests: { label: 'Special Interests', name: 'specialInterests', ...globalState.assessments.behaviorInterests.domains.specialInterests },
                  sensoryInterests: { label: 'Sensory Interests', name: 'sensoryInterests', ...globalState.assessments.behaviorInterests.domains.sensoryInterests },
                  emotionalRegulation: { label: 'Emotional Regulation', name: 'emotionalRegulation', ...globalState.assessments.behaviorInterests.domains.emotionalRegulation },
                  flexibility: { label: 'Flexibility', name: 'flexibility', ...globalState.assessments.behaviorInterests.domains.flexibility }
                },
