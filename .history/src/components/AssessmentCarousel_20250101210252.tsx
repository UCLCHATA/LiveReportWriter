...
const getTooltipContent = (title: string): string => {
  switch (title) {
    ...
    case 'Milestone Tracker':
      return 'Track and monitor developmental milestones across key domains including motor skills, language development, social-emotional growth, and cognitive abilities.';
    case 'Assessment Log':
      return 'Record and monitor assessment progress, including session notes, observations, and progress tracking over time.';
    default:
      return '';
  }
};
    ...
    <div className={styles.carouselContainer}>
      <div className={styles.carouselHeader}>
        ...
        <div className={styles.titleSection}>
          ...
          <div className={styles.toolkitButton} title={getTooltipContent(tools[currentIndex].title)}>
            <HelpCircle size={20} />
          </div>
        </div>
