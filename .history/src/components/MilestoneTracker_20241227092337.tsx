...
const getStackPosition = (
  ...
  const milestonesAtPosition = milestones
    .filter(m => m.actualAge === currentMonth)
    .sort((a, b) => a.id.localeCompare(b.id));
  
  return milestonesAtPosition.findIndex(m => m.id === currentId);
};
...
export const MilestoneTracker: React.FC = () => {
  ...
  const handleDragMove = (event: any) => {
    ...
    if (timeline) {
      ...
      // Update current month and store vertical position
      setCurrentMonth(month);
      // Store vertical position as percentage
                  ...
                  return (
                    <motion.div
                      ...
                      style={{
                        ...
                        top: `${stackPosition * 40}px` // Adjust this value to control spacing
                      }}
