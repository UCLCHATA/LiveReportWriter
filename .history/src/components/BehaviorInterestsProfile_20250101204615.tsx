...
export const BehaviorInterestsProfile: React.FC = () => {
  const [domains, setDomains] = useState<Domain[]>([
    { name: 'Repetitive Behaviors', value: 3, observations: [], label: 'Moderate Impact' },
    { name: 'Restricted Interests', value: 3, observations: [], label: 'Moderate Impact' },
    { name: 'Sensory Seeking', value: 3, observations: [], label: 'Moderate Impact' },
    { name: 'Routine Adherence', value: 3, observations: [], label: 'Moderate Impact' },
    { name: 'Flexibility', value: 3, observations: [], label: 'Moderate Impact' },
    { name: 'Activity Transitions', value: 3, observations: [], label: 'Moderate Impact' },
  ]);
