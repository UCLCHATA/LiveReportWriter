...
const getTooltipContent = (section: string): string => {
  switch (section) {
    case 'Clinical Observations':
      return 'Document key behavioral observations, communication patterns, sensory responses, and social interactions noted during the assessment. Include specific examples and contexts.';
    case 'Strengths & Abilities':
      return 'Highlight individual strengths, special interests, and capabilities that can support development and learning. Consider both typical and unique abilities.';
    case 'Priority Support Areas':
      return 'Identify key areas requiring immediate intervention or support based on impact on daily functioning and development. Consider family priorities and available resources.';
    case 'Support Recommendations':
      return 'Provide specific, actionable recommendations for support strategies, accommodations, and interventions. Consider home, school, and community contexts.';
    case 'Status':
      return 'Select current diagnostic status for ASC and ADHD based on assessment findings and clinical judgment.';
    case 'Referrals':
      return 'Indicate recommended specialist referrals based on identified needs and assessment findings.';
    default:
      return '';
  }
};
