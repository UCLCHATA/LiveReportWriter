...
export const AssessmentCarousel: React.FC<AssessmentCarouselProps> = ({
  ...
  const transformToAssessmentData = (data: any, type: 'sensoryProfile' | 'socialCommunication' | 'behaviorInterests') => {
    ...
    console.log('🔄 Transforming assessment data:', {
      type,
      originalData: data,
      transformedData: { domains }
    });
    
    return { domains } as Partial<SensoryProfileAssessment | SocialCommunicationAssessment | BehaviorInterestsAssessment>;
  };
  ...
  }, [currentIndex, progress, completionStatus, globalState.assessments]);
