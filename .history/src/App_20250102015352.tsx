...
export const App: React.FC = () => {
  ...
  return (
    <div className="app">
      <Header chataId={chataId} progress={formProgress} />
        ...
        {!showForm ? (
          ...
          <>
            <div className="left-panel active">
              <AssessmentCarousel onProgressUpdate={(progress) => handleFormProgress(progress)} />
            </div>
            <div className="right-panel active">
              <div className="form-container active">
                <AssessmentForm onClear={handleClearForm} onProgressUpdate={(progress) => handleFormProgress(progress)} />
              </div>
            </div>
          </>
        )}
