...
import { useFormState, STORAGE_KEY } from './contexts/FormStateContext';
...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (!showForm && hasContent) {
      console.log('📋 Found clinical observations:', {
        content: globalState.formData.clinicalObservations,
        length: globalState.formData.clinicalObservations?.length || 0
      });
      setShowForm(true);
