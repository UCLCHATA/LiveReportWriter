...
export const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (globalState.formData?.formProgress || globalState.assessments?.sensoryProfile.progress) {
  ...
  const handleCarouselProgressUpdate = (progress: number) => {
    ...
    Object.keys(globalState.assessments).forEach(key => {
      updateAssessment(key as keyof AssessmentData, { progress });
    });
  };
