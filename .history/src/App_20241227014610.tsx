...
import { SensoryProfileBuilder } from './components/SensoryProfileBuilder';
...
type ComponentType = 'milestones' | 'sensory' | 'behavioral';

export const App: React.FC = () => {
  const [showForm, setShowForm] = useState(false);
  const [clinicianInfo, setClinicianInfo] = useState({ name: '', email: '' });
  const [activeComponent, setActiveComponent] = useState<ComponentType>('milestones');
          ...
          <div className="left-panel active">
            <div className="left-panel-components">
              <nav className="component-nav">
                <button 
                  className="component-nav-button active"
                  onClick={() => handleComponentChange('milestones')}
                >
                  Milestones
                </button>
                <button 
                  className="component-nav-button"
                  onClick={() => handleComponentChange('sensory')}
                >
                  Sensory
                </button>
                <button 
                  className="component-nav-button"
                  onClick={() => handleComponentChange('behavioral')}
                >
                  Behavioral
                </button>
              </nav>
              ...
              <div className="component-container">
                <div className={`component-section ${activeComponent === 'milestones' ? '' : 'hidden'}`}>
                  <MilestoneTracker />
                </div>
                <div className={`component-section ${activeComponent === 'sensory' ? '' : 'hidden'}`}>
                  <SensoryProfileBuilder />
                </div>
                <div className={`component-section ${activeComponent === 'behavioral' ? '' : 'hidden'}`}>
