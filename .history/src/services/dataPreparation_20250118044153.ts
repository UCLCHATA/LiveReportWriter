...
export function prepareFormDataForSubmission(globalState: any): any {
    ...
    const milestoneData = globalState.assessments?.milestones;
    console.log('🔍 Raw milestone data:', milestoneData);

    // Check for image inclusion flags
    const includeImages = !!(milestoneData?.milestoneImage?.include || milestoneData?.includeTimelineInReport);
    console.log('📸 Image inclusion flags:', {
        milestoneImageInclude: milestoneData?.milestoneImage?.include,
        includeTimelineInReport: milestoneData?.includeTimelineInReport,
        finalIncludeImages: includeImages
    });
    ...
    const submissionData = {
        ...
        // Image flags and data
        includeImages: includeImages,
        milestoneImage: milestoneData?.milestoneImage || { include: false },
