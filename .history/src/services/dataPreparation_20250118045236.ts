...
export function prepareFormDataForSubmission(globalState: GlobalFormState) {
    ...
    return {
        ...
        ...prepareSensoryProfileData(sensoryProfile),
        ...prepareSocialCommunicationData(socialCommunicationProfile),
        ...prepareBehaviorInterestsData(behaviorInterestsProfile),
        ...prepareMilestoneData(milestoneData),
        ...formatAssessmentLogData(assessmentLog),
