...
const ALERT_MESSAGES = {
  SUCCESS: '✓ Form submitted successfully! Your report will be generated and emailed to you shortly.',
  ERROR: (message) => `❌ Form submission failed: ${message}\nPlease try again or contact support if the problem persists.`,
  INVALID_DATA: 'Invalid submission data. Please check all required fields.'
};
