...
export class FormPersistenceService {
  ...
  getForm(chataId: string): StoredForm | null {
    ...
    // Ensure form has a valid form state
    const formWithValidState = {
      ...form,
      formState: {
        ...this.createDefaultFormState(),
        ...form.formState
    ...
    console.log('[FormPersistence] Found form:', {
      chataId: formWithValidState.chataId,
      hasClinicianInfo: !!formWithValidState.clinicianInfo,
      hasFormState: !!formWithValidState.formState,
      hasAssessmentState: !!formWithValidState.assessmentState
    });
    return formWithValidState;
  }
