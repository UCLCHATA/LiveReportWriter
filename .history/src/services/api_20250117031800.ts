...
function formatFormData(formData: any) {
  ...
  console.log('👤 Clinical Information:', {
    ...
    childInfo: {
      firstName: formData.clinician?.childFirstName,
      secondName: formData.clinician?.childLastName,
      age: formData.clinician?.childAge,
      gender: formData.clinician?.childGender
    }
  });
  ...
  console.log('📝 Assessment Form Texts:', {
    ...
    supportAreas: formData.formData?.priorityAreas || ''
  });
  ...
  const formatted = {
    r3Form: {
      ...
      // Form Data
      clinicalObservations: formData.formData?.clinicalObservations || '',
      strengthsAbilities: formData.formData?.strengths || '',
      prioritySupportAreas: formData.formData?.priorityAreas || '',
      supportRecommendations: formData.formData?.recommendations || '',
      additionalRemarks: formData.formData?.remarks || '',
      differentialDiagnosis: formData.formData?.differentialDiagnosis || '',
      ...
      visualObservations: formatObservations(sensoryProfile.visual?.observations),
      auditoryScore: formatSensoryScore(sensoryProfile.auditory),
      auditoryObservations: formatObservations(sensoryProfile.auditory?.observations),
      tactileScore: formatSensoryScore(sensoryProfile.tactile),
      tactileObservations: formatObservations(sensoryProfile.tactile?.observations),
      vestibularScore: formatSensoryScore(sensoryProfile.vestibular),
      vestibularObservations: formatObservations(sensoryProfile.vestibular?.observations),
      proprioceptiveScore: formatSensoryScore(sensoryProfile.proprioceptive),
      proprioceptiveObservations: formatObservations(sensoryProfile.proprioceptive?.observations),
      oralScore: formatSensoryScore(sensoryProfile.oral),
      oralObservations: formatObservations(sensoryProfile.oral?.observations),
      
      // Social Communication Profile
      jointAttentionScore: formatSocialScore(socialProfile.jointAttention),
      jointAttentionObservations: formatObservations(socialProfile.jointAttention?.observations),
      nonverbalCommunicationScore: formatSocialScore(socialProfile.nonverbalCommunication),
      nonverbalCommunicationObservations: formatObservations(socialProfile.nonverbalCommunication?.observations),
      verbalCommunicationScore: formatSocialScore(socialProfile.verbalCommunication),
      verbalCommunicationObservations: formatObservations(socialProfile.verbalCommunication?.observations),
      socialUnderstandingScore: formatSocialScore(socialProfile.socialUnderstanding),
      socialUnderstandingObservations: formatObservations(socialProfile.socialUnderstanding?.observations),
      playSkillsScore: formatSocialScore(socialProfile.playSkills),
      playSkillsObservations: formatObservations(socialProfile.playSkills?.observations),
      peerInteractionsScore: formatSocialScore(socialProfile.peerInteractions),
      peerInteractionsObservations: formatObservations(socialProfile.peerInteractions?.observations),
      
      // Behavior Interests Profile
      repetitiveBehaviorsScore: formatBehaviorScore(behaviorProfile.repetitiveBehaviors),
      repetitiveBehaviorsObservations: formatObservations(behaviorProfile.repetitiveBehaviors?.observations),
      routinesRitualsScore: formatBehaviorScore(behaviorProfile.routinesRituals),
      routinesRitualsObservations: formatObservations(behaviorProfile.routinesRituals?.observations),
      specialInterestsScore: formatBehaviorScore(behaviorProfile.specialInterests),
      specialInterestsObservations: formatObservations(behaviorProfile.specialInterests?.observations),
      sensoryInterestsScore: formatBehaviorScore(behaviorProfile.sensoryInterests),
      sensoryInterestsObservations: formatObservations(behaviorProfile.sensoryInterests?.observations),
      emotionalRegulationScore: formatBehaviorScore(behaviorProfile.emotionalRegulation),
      emotionalRegulationObservations: formatObservations(behaviorProfile.emotionalRegulation?.observations),
      flexibilityScore: formatBehaviorScore(behaviorProfile.flexibility),
      flexibilityObservations: formatObservations(behaviorProfile.flexibility?.observations),
