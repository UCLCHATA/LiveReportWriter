...
function formatDomainData(domain: any): string {
    ...
    // Check if the domain has been actively set
    ...
    if (isUnused) {
        console.log('✓ Skipping observations - domain not actively set');
        return '';
    }
...
function formatDomainScore(domain: any): string {
    ...
    if (isUnused) {
        console.log('✓ Marking as Skipped - domain not actively set');
        return 'Skipped';
    }
