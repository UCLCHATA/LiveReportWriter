...
function formatFormData(formData: any) {
    ...
    console.log('👤 Clinical Information:', {
        ...
        childInfo: {
            ...
            secondName: formData.childLastName,
    ...
    console.log('🎯 Sensory Profile Scores:', formData.sensoryScores || {});
    console.log('🤝 Social Communication Scores:', formData.socialScores || {});
    console.log('🔄 Behavior Interests Scores:', formData.behaviorScores || {});
