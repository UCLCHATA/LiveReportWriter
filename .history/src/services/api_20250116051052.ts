...
function formatFormData(formData: any) {
    return {
        r3Form: {
            ...
            supportAreas: String(formData.priorityAreas || ''),
            ...
            milestones: String(formData.milestones ? JSON.stringify(formData.milestones) : ''),
            milestoneHistory: String(formData.milestoneHistory || ''),
            radarChartImage: String(formData.radarChartImage || ''),
            timelineImage: String(formData.timelineImage || ''),
            status: 'submitted',
