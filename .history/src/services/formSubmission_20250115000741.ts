...
export const submitFormData = async (data: FormSubmissionData) => {
  ...
  // Get existing images from state if they exist
  ...
  // Only capture images if they should be included and don't exist in state
  ...
  console.log('Image data:', {
    timelineImage: timelineImage ? `[base64 string length: ${timelineImage.length}]` : 'Not present',
    radarChartImage: radarChartImage ? `[base64 string length: ${radarChartImage.length}]` : 'Not present'
  });
