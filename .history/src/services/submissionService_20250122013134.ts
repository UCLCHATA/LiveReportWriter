    ...
    try {
        ...
        if (data.milestoneImageData[SHEETY_HEADERS.IMAGES.milestoneImage]) {
            ...
            const milestoneResponse = await submitFormData({
                ...data.mainData,  // Include basic identifiers
