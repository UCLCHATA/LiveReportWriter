...
export class SubmissionService {
  private static validateSubmissionData(globalState: GlobalFormState): boolean {
    ...
    console.log('Clinician data:', {
        ...
        clinic: globalState.clinician?.clinicName,
        childInfo: {
            firstName: globalState.clinician?.childFirstName,
            lastName: globalState.clinician?.childLastName
        }
    });
    ...
    if (!globalState.clinician?.name || !globalState.clinician?.email || !globalState.clinician?.clinicName) {
