...
export const submitFormData = async (data: FormSubmissionData) => {
  ...
  const rawData = {
    ...
    ...splitBase64Image(timelineImage, !!data.globalState.assessments.milestones?.includeTimelineInReport, 25000)
    ...
    // Combined Graph
    ...splitBase64Image(radarChartImage, !!data.globalState.assessments.summary?.includeInReport, 25000)
      .reduce((acc, chunk, index) => ({
        ...acc,
