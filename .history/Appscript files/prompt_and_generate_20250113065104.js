...
function testPromptGeneration() {
  ...
  try {
    ...
    const testData = {
      ...
      // Sensory Profile (with scores 1-5 and detailed observations)
      Visual_Score: 3,
      ...
      // ... [rest of the sensory profile data as in your spreadsheet]
      ...
      // ... [rest of the social communication data]
      
      // Assessment Data
      Assessment_Log_Data: '2024-03-15: ADOS-2 Assessment: Showed characteristic patterns in social communication and interaction. Engaged well with structured activities.',
      ...
      // Clinical Insights
      Clinical_Observations: 'Alex demonstrates a clear autism spectrum profile with particular strengths in visual processing and specific interests.',
      Strengths_Abilities: 'Strong visual learning skills, extensive knowledge in areas of interest, good memory',
      Priority_Support_Areas: 'Social communication skills, emotional regulation in overwhelming environments',
    ...
    const placeholderMap = {
      ...
      // ... [similar detailed mappings for other placeholders]
    };
...
INPUT FORMAT:
The data includes:
1. Sensory Profile (scores + observations)
2. Social Communication Profile (scores + observations)
3. Behavior & Interests Profile (scores + observations)
