    ...
    // Modify the populateTemplate function to include image handling
    function populateTemplate(templateDoc, responses) {
        ...
        // Helper function to reconstruct image from chunks
        ...
        if (responses.formData) {
            ...
            imageTypes.forEach(imageType => {
                const base64Data = reconstructImageFromChunks(responses.formData, imageType);
