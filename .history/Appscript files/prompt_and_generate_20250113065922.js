...
1. Sensory Profile
   - Scores (1-5 scale)
   - Detailed observations for each domain
   - Visual, Auditory, Tactile, Vestibular, Proprioceptive, Oral

2. Social Communication Profile
   - Scores (1-5 scale)
   - Observations for each area
   - Joint Attention, Social Reciprocity, Verbal/Non-verbal Communication
   - Social Understanding, Play Skills

3. Restricted Patterns Profile
   - Scores (1-5 scale)
   - Detailed observations
   - Repetitive Behaviors, Routines, Special Interests
   - Sensory Interests
